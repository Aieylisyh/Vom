...
namespace vom
{
    public class MailService : MonoBehaviour
    {
        ...
        public void AddMailLevelPassed(string LevelTitleKey, List<ItemData> rewards)
        {
        ...
        private void AddWelcomeMail()
        {
            ...
            mail.SetSendNow();
            mail.rewards = new List<ItemData>();
            mail.rewards.Add(new ItemData(100, "Gold"));
        ...
        private void AddCreditMail()
        {
            ...
            mail.rewards.Add(new ItemData(1, "Emerald"));
            //mail.rewards.Add(new Item(10, "TurtleRock"));
            mail.rewards.Add(new ItemData(1, "Diamond"));
            Add(mail);
        }
        ...
        private void AddWeek1Mail()
        {
            ...
            mail.rewards = new List<ItemData>();
            mail.rewards.Add(new ItemData(1, "Fish6"));
            Add(mail);
        }
        ...
        private void AddDay1Mail()
        {
            ...
            mail.rewards = new List<ItemData>();
            mail.rewards.Add(new ItemData(1, "Emerald"));
            mail.rewards.Add(new ItemData(3000, "Gold"));
            mail.rewards.Add(new ItemData(1, "Diamond"));
            Add(mail);
        }
        private void AddDay2Mail()
        {
            ...
            mail.rewards = new List<ItemData>();
            mail.rewards.Add(new ItemData(5, "Diamond"));
            mail.rewards.Add(new ItemData(5000, "Gold"));
            Add(mail);
        }
        ...
        private void AddHolidayMail(int month, int day)
        {
            ...
            mail.rewards = new List<ItemData>();
            mail.rewards.Add(new ItemData(7, "ChestGold"));
            Add(mail);
        }
    }
}