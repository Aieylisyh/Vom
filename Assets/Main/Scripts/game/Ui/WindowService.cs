...
namespace game
{
    public class WindowService : MonoBehaviour
    {
        ...
        public void OnPortView()
        {
            LevelHudBehaviour.instance.Hide();
            MainHudBehaviour.instance.RefreshToDefault();
            MainButtonsBehaviour.instance.Refresh();
            MainSceneManager.instance.Refresh();
            ShowMainButtons();
        }
